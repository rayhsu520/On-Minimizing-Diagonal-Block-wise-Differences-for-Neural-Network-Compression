...
#----------- compress with editgraph format ------------------------------------------
            ...
            fc_t += t0
            fc_d += d0
            #fc_edit_bit, fc_edit_compress=huffman_encode_editgraph(fc_edit.astype(numpy.float32), 2**args.index_bits)
            ...
            #print(f"original:{fc_bit+fc_edit_bit} bytes\t after:{fc_compressed_bit+fc_edit_compress} bytes")
