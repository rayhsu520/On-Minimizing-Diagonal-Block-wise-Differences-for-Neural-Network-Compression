...
class LeNet5_mask(PruningModule):
    def __init__(self, LeNet5_maskname, partitions, mask_flag=False):
        ...
        self.block_row_size1,self.block_col_size1,self.rowp1,self.colp1,self.mask1= mask(50*4*4,500, int(partitions['fc1']))
        ...
        self.block_row_size2,self.block_col_size2,self.rowp2,self.colp2,self.mask2= mask(500,10, int(partitions['fc2']))
